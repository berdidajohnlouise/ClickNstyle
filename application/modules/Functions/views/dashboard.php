        ...
        <form action="<?php echo base_url();?>Functions/Account_management/updateprofile" method="post" enctype="multipart/form-data">
          ...
          <h2>Salon Information</h2>
              ...
              <div class="form-group">
                ...
                <input type="time" class="form-control" name="openhours" value="<?php echo $userdetails->open_hours;?>" required>
              </div>

              <div class="form-group">
                <label for="ownername">Closing Hours:</label>
                <input type="time" class="form-control" name="closehours" value="<?php echo $userdetails->closing_hours; ?>" required>
              </div>
