...
class Account_management extends MY_Controller{
  ...
  function updatestaffprofile(){
    ...
    //print_r($staffdetails);
        ...
        if( ! $this->upload->do_upload($filename)){
          ...
          $success = $this->Account_management_m->updatestaffProfile($staffdetails);

          if($success =='True'){
            redirect('Functions/staff_user');
          }
        }else{
  ...
  function staffinformation(){
    ...
    $success = $this->Account_management_m->staffinformation($userinfo);
