              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Staff_management_user_salon/addStaffUser" class="staffInfo" method="post">
                    <div class="col-md-4">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Staff_management_user_salon/updateSU" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
