              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Services_management_salon/addServices" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="serviceduration" required>
                            ...
                            <option value="4.5">4 Hours and 30 minutes</option>
                            <option value="5">5 Hours</option>
                            <option value="5.5">5 Hours and 30 minutes</option>
                          </select>
                        </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Services_management_salon/updateservices" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
