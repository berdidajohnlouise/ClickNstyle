              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Products_management_salon/addProduct" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Products_management_salon/updateProduct" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
