              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Calendar_management_salon/addCalendar" method="post">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Calendar_management_salon/updateCalendar" method="post" enctype="multipart/form-data">
