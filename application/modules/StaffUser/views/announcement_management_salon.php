              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Announcement_management_salon/addAnnouncement" method="post">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Announcement_management_salon/updateAnnouncement" method="post" enctype="multipart/form-data">
