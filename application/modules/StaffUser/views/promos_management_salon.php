              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Promos_management_salon/addPromo" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>StaffUser/Promos_management_salon/updatepromo" method="post" enctype="multipart/form-data">
                    <div class="col-md-4">
