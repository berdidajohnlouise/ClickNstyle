...
<div class="main-navigation">
  ...
  <ul class="menu">
    ...
    <li class="menu-item current-menu-item"><a href="<?php echo base_url();?>GlobalService/about">About</a></li>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<figure><img src="<?php echo base_url();?>assets/dummy/figure-1.jpg" alt=""></figure>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="team small">
											<figure class="team-image"><img src="<?php echo base_url();?>assets/dummy/person-1.jpg"></figure>
											<h3 class="team-name">Sarah james</h3>
											<p>Lorem ipsum dolor sit amet, consectetur</p>
										</div>
										<div class="team small">
											<figure class="team-image"><img src="<?php echo base_url();?>assets/dummy/person-2.jpg"></figure>
									...
									<div class="col-md-6">
										<div class="team small">
											<figure class="team-image"><img src="<?php echo base_url();?>assets/dummy/person-3.jpg"></figure>
											<h3 class="team-name">Nicole Johnson</h3>
											<p>Lorem ipsum dolor sit amet, consectetur</p>
										</div>
										<div class="team small">
											<figure class="team-image"><img src="<?php echo base_url();?>assets/dummy/person-4.jpg"></figure>
