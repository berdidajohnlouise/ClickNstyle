    ...
    if(confirm('Are you sure you want to delete this Staff ?')==true){
      ...
      $.post(url,function(result){
        ...
        if(result1=='True'){
          ...
          window.location.href = "<?php echo base_url();?>StaffUser/Staff_management_salon";
        }
        else{
    ...
    if(confirm('Are you sure you want to delete this Service ?')==true){
      ...
      $.post(url,function(result){
        ...
        if(result1=='True'){
          ...
          window.location.href = "<?php echo base_url();?>StaffUser/Services_management_salon";
        }
        else{
          alert('Developer nga bogo');
        }
    ...
    if(confirm('Are you sure you want to delete this Promo ?')==true){
      ...
      $.post(url,function(result){
        ...
        if(result1=='True'){
          ...
          window.location.href = "<?php echo base_url();?>StaffUser/Promos_management_salon";
        }
        else{
          alert('Developer nga bogo');
        }
  ...
  if(confirm('Are you sure you want to delete this Product ?')==true){
    ...
    $.post(url,function(result){
      ...
      if(result1=='True'){
        ...
        window.location.href = "<?php echo base_url();?>StaffUser/Products_management_salon";
      }
      else{
        alert('Developer nga bogo');
      }
  ...
  if(confirm('Are you sure you want to delete this Announcement ?')==true){
    ...
    $.post(url,function(result){
      ...
      if(result1=='True'){
        ...
        window.location.href = "<?php echo base_url();?>StaffUser/Announcement_management_salon";
      }
      else{
        alert('Developer nga bogo');
      }
  ...
  if(confirm('Are you sure you want to delete this Staff Account ?')==true){
    ...
    $.post(url,function(result){
      ...
      if(result1=='True'){
        ...
        window.location.href = "<?php echo base_url();?>StaffUser/Staff_management_user_salon";
      }
      else{
        alert('Developer nga bogo');
      }
  ...
  if(confirm('Are you sure you want to delete this Event?')==true){
    ...
    $.post(url,function(result){
      ...
      if(result1=='True'){
        ...
        window.location.href = "<?php echo base_url();?>StaffUser/Calendar_management_salon";
      }
      else{
        alert('Developer nga bogo');
      }
      ...
      if(confirm('Confirm this reservation.')==true){
        ...
        $.post(url,function(result){
          ...
          if(result1=='True' || result == true){
            ...
            window.location.href = "<?php echo base_url();?>StaffUser/Reservation_management_salon";
          }
          else{
            alert('Developer nga bogo');
          }
